...
public enum CardCollection{
	...
	PUPILO_DE_LAS_MAREAS(6), OSTRA_POTENCIADORA(7), ORACULO_DEL_OCEANO(8), GEISER(9), PLUVIAM(10),
	...
	CHAMAN_DE_LA_MONTAÑA(36), BATALLON_MERCENARIO(37), FOSA_TECTONICA(38), GORE_EL_TORTURADOR(39), DOTON(40),
